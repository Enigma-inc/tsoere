    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2 margin-top-60">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('track.store',['artistId'=>Auth::user()->profile->id]) }}"
                        ...
                        <div class="form-group{{ $errors->has('artwork') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="artwork" type="file" class="form-control" name="artwork" accept=".jpg,.png,.jpeg" required>     
