<div class="social-buttons">
    ...
    <a href="whatsapp://send?text={{$track->path}}" type="button" class="btn btn-md ink-reaction btn-floating-action btn-default-bright" target="_blank">
        <i data-toggle="tooltip" title="share on whatsapp" class="text-success text-ultra-bold fa fa-whatsapp"></i>
    </a>                                        
    <a href="https://twitter.com/intent/tweet?url={{$track->path}}" data-toggle="tooltip" title="share on twitter" target="_blank" type="button" class="btn btn-md ink-reaction btn-floating-action btn-default-bright">
