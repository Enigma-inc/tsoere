<div class="social-buttons">
    ...
    <a href="https://twitter.com/intent/tweet?url={{ urlencode("'/artist/$track->artist->slug/single/$track->slug'")}}" data-toggle="tooltip" title="share on twitter" target="_blank" type="button" class="btn btn-md ink-reaction btn-floating-action btn-default-bright">
