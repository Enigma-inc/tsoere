  ...
  <div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="lineModalLabel">Add Your Additional Information</h4>
		</div>
		<div class="modal-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{route('profile.additionalinfo',['artistId'=>Auth::user()->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="margin-bottom-40 form-group{{ $errors->has('booking_phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                            <input id="booking_phone" type="text" class="form-control" name="booking_phone">
                        ...
                        <div class="margin-bottom-40 form-group{{ $errors->has('booking_email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                            <input id="booking_email" type="email" class="form-control" name="booking_email">
                        ...
                        <div class="margin-bottom-40 form-group{{ $errors->has('about') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                            <textarea name="about" id="textarea1" class="form-control" rows="3" ></textarea>
                                @if ($errors->has('about'))
                                    <span class="help-block">
